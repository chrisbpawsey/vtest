...
#     chown -R vagrant:vagrant data-shell
     ...
     echo ---------------
     sudo -H -u vagrant bash -c 'which maali'
   SHELL
   #config.vm.provision "shell",
  #  inline:  "/home/vagrant/maali-1.5/install_scripts/Install_gadget_ubuntu_18.sh"
#     sudo -H -u vagrant bash -c './maali-1.5/install_scripts/Install_gadget_ubuntu_18.sh'
